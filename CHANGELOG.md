...
- CPC was rewritten as a faithful port of the Apache algorithm (ICON and HIP estimators, kxp lookup, flavour machinery, union), fixing a 173% estimation error to Apache parity (0.34% on synthetic, 1.17% on a real TPC-H column).
...
- Documentation rewritten with honest, multi-trial-RMSE-measured accuracy numbers and Tahoma-styled comparison plots; fabricated performance claims removed.
